    ...
    return(
        ...
        <section className="flex justify-between px-[16px] gap-[32px] items-center flex-col md;flex-row">
            <aside className="md:w-[500px] lg:w-[900px]">
                <div className="mb-10">
                    <p className="text-3xl md:text-[48px] font-[600] py-2">Everyone can be a chef in their own kitchen</p>
                    <p>Lorem ipsum dolor sit amet, consectetuipisicing elit, sed do eiusmod tempor incididunt ut l
                        abore et dolore magna aliqut enim ad minim </p>
                </div>
