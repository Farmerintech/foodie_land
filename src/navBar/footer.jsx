...
export const Footer = () => {
  return (
    <section className="px-[16px] md:px-[64px]">
      <section className="py-20 bg-[#E7F9FD] rounded-[32px] my-20 relative px-[5px]">
        <div className="flex flex-col items-center justify-center gap-4 md:gap-10 text-center">
          <p className="font-[600] text-3xl md:text-[48px]">
        ...
        <div className="bg-white py-[12px] gap-5 md:px-[16px] px-[8px] flex justify-between rounded-[16px]  w-full md:w-[480px] lg:w-[500px] md:mx-auto my-10">
          ...
          />
          <button className="bg-black text-white py-[8px] px-[16px] rounded-[8px]">
            Subscribe
          </button>
        </div>
        <div>
          <div className="">
            <img
              src={Salad}
              className="absolute w-[120px] md:w-[300px] bottom-0 left-0 rounded-b-[32px]"
            />
          </div>
          <div className="">
            <img
              src={SaladPlate}
              className="w-[120px] md:w-[200px] absolute bottom-0 right-0 rounded-b-[32px]"
            />
          </div>
          <div className="">
            <img
              src={Leaf}
              className="w-[50px] md:w-[100px] absolute bottom-20 right-30 md:bottom-30 md:right-50 rounded-b-[32px]"
            />
          </div>
        </div>
      </section>
